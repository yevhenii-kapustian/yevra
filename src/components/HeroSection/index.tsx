...
const SLIDES = [
  {
    ...
    videoPosition: "top",
    eyebrow: "WEARABLE REMINDERS",
    headline: "Wear The Words You Needed To Hear",
    subtext: "Small phrases, worn close — for the days you need the reminder most.",
    ctaLabel: "Shop Now",
  ...
  },
  {
    ...
    eyebrow: "MORE THAN A BAG",
    headline: "Held, Wherever You Go",
    subtext: "Accessories that carry a little more than your things.",
